    ...
    <div className='projects-container'>
      ...
      <div className='project-card-container'>
        ...
        <div className='card-text'>
          <h2>Journey Down</h2>
          <p>
            The goal for Journey Down was to make an easy RPG mobile game with a focus on one-hand play and randomized loot. <br></br><br></br>
            I worked on the combat system for this while my partner Marvin Jung worked on the randomized loot system. <br></br><br></br>
            What I learned from this project is how important communication is in development. When it came time to put our systems together we come to realize my combat system and Marin's loot system were incompatible making it very difficult to put them together. <br></br>
      ...
      <div className='project-card-container'>
        ...
        <div className='card-text'>
          ...
          <p>
            The goal for Terror in Herrington was to make a top-down adventure game with a focus on exploring. <br></br><br></br>
